...
import '../../../notes/presentation/widgets/responsive_layout.dart';
...
class _LoginScreenState extends State<LoginScreen>
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(child: _buildFormCard(maxWidth: 400)),
                ],
              ),
            ),
          ),
            ...
            child: Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(child: _buildFormCard(maxWidth: 450, isLarge: true)),
                ],
              ),
            ),
          ),
    ...
    return FadeTransition(
      ...
      child: SlideTransition(
        ...
        child: Container(
          ...
          child: Icon(Icons.notes_rounded, size: size * 0.5, color: Colors.white),
        ),
      ),
    );
  }
  ...
  Widget _buildSubtitle({double fontSize = 16}) {
    return FadeTransition(
      opacity: _fadeAnimation,
  ...
  Widget _buildFormCard({double? maxWidth, bool isLarge = false}) {
    return FadeTransition(
      opacity: _fadeAnimation,
      child: Container(
